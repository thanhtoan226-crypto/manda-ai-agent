...
- AI asks the user to choose a conversation mode:
...
### Sample Session (1-on-1 Prep Report)

**Subject**: Chris Peterson (Engineering Manager)

**Persona**: Chris is an "Outlier" in meeting hours vs. peers.

**Key Insight**: Heavily involved in Q4 Planning and Urgent Ad-hoc sessions → low Deep Work scores.
...
**Mock Calendar Data** (Meetings He Organizes):

| Meeting | Hours | Cost | Intent | Alignment |
|---------|-------|------|--------|-----------|
| Q4 Planning | 6 | High | Strategic Alignment | High |
| Urgent Ad-hoc | 5 | Medium | Reactive | Low |
| 1-on-1s | 4 | Low | Development | High |
| Sprint Reviews | 3 | Medium | Operational | Medium |
...
**Drill-Down Content** (lorem ipsum for deeper level):

- "Detailed breakdown of ad-hoc meeting patterns: Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua."
- "Quarterly trend analysis: Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris."
